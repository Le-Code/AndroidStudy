...
import com.example.jerry.androidstudy.*;
import com.example.jerry.androidstudy.singleChat.entity.MessageBean;
import com.example.jerry.androidstudy.singleChat.entity.MessageFileBean;
...
public class SingleChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //添加接受消息队列
        ChatApplication.chatServer.setHandler(new Handler(){
            @Override
            public void handleMessage(Message msg) {
                if (msg.what==1){
                    //发送回来消息后，更新ui
                    MessageBean messageBean = (MessageBean) msg.obj;
                    chat_ly.addView(initLeftView(messageBean.getContent()));
                }
            }
        });
